...
def create_config(genome_build, cores_per_job, fastq_dir, output_dir, target_yaml):

    cli.config.create_config(genome_build, cores_per_job, output_dir, target_yaml)
